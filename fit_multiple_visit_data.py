...
if not binning:
    ...
    out_name = 'data_multi_visit_gp_'+bulk+'-'+element+'atmosphere'

else:

    out_name = 'data_multi_visit_gp_'+bulk+'-'+element+'atmosphere_binnedR'+str(R)
...
def loglike(theta):
    ...
    T, MR, Pcloud, offset1, rho1, gp_sigma1, sigma_w1, \
    ...
    if (T > a_T and T < b_T) and (MR > a_MR and MR < b_MR) and (Pcloud > a_Pcloud and Pcloud < b_Pcloud) and \
...
def prior_transform(utheta):
    ...
    uT, uMR, uPcloud, uoffset1, urho1, ugp_sigma1, usigma_w1, \
    ...
    MR = transform_uniform(uMR, [a_MR, b_MR])
    ...
    #print('In prior transform:', T, MR, Pcloud, offset, rho, gp_sigma, sigma_w)
    return T, MR, Pcloud, offset1, rho1, gp_sigma1, sigma_w1, offset2, rho2, gp_sigma2, sigma_w2, offset3, rho3, gp_sigma3, sigma_w3, offset4, rho4, gp_sigma4, sigma_w4 
...
# Run dynesty:
def run_dynesty(out_name, nthreads):
        ...
        if not multiprocessing:
            ...
            with mp.Pool(nthreads) as pool:
                ...
                dsampler = dynesty.DynamicNestedSampler(loglike, prior_transform, ndim=19,
                                                        ...
                                                        pool = pool, queue_size = nthreads, rstate=rstate)
...
if __name__ == '__main__':
    ...
    out, results = run_dynesty(out_name, nthreads)
